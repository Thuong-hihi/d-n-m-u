...
<p class="p-3 text-[28px] border bg-[#EEE] rounded-md">
    ...
    <div  class="mt-[20px]">
        ...
        <tr class="bg-[#FFC0CB] py-2 border text-center text-red-600 h-[50px]" >
            ...
            <td class="w-[140px]">Mã Loại Hàng</td>
            <td class="border ">Tên Loại Hàng</td>
            ...
            <tr>
                    ...
                    <td class="border h-[50px]">
                     <a href="<?=$suadm?>"><input type="button" value="Sửa" class="border w-[50px] hover:bg-[#FFC0CB]"></a>
                    <a onclick="return confirm('Bạn có chắc chắn muốn xóa?')" href="<?=$xoadm?>"><input type="button" value="Xóa"  class="border w-[40px] hover:bg-[#FFC0CB]"></a> 
                    </td>
                </tr>
         <?php
                }
    ...
    <div class="action w-full mx-auto mt-4 space-x-1 mt-[20px] ">
        ...
        <a href="index_admin.php?act=adddm"><input type="button" value="Nhập Thêm" class="  mx-auto  ml-[10px]"></a>
    </div>
</div>
<!DOCTYPE html>
<html lang="en">
