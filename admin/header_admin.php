            ...
            <div class="menu my-6 py-2 text-red-800 bg-[#FFC0CB] rounded-md">
                <nav>
                    <ul class="pl-4 flex items-center space-x-10 text-xl ">
                        ...
                        <li class="hover:underline">
                            <a href="index_admin.php?act=adddm">Danh Mục</a>
                        </li>
                        <li class="hover:underline">
                            <a href="index_admin.php?act=addsp">Sản Phẩm</a>
                        </li>
                        <li class="hover:underline">
                            <a href="index_admin.php?act=list">Khách Hàng</a>
                        </li>
                        <li class="hover:underline">
                            <a href="index_admin.php?act=dsbl">Bình Luận</a>
                        </li>
                        <li class="hover:underline">
                            <a href="index_admin.php?act=thongke">Thống Kê</a>
                        </li>
                    </ul>
                </nav>
            </div> <!-- End .menu-->
